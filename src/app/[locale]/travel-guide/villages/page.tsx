    ...
    <main className="min-h-screen bg-cream">
      ...
      <section className="relative py-20 px-6 bg-navy">
        <div className="max-w-5xl mx-auto">
          ...
          >
            A la Decouverte des Plus Beaux Villages du Perigord Noir
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Le Perigord Noir abrite certains des plus beaux villages de France. Perches sur des
            falaises, nichees au bord de la Dordogne ou dominant des vallees verdoyantes, ces
            villages medievaux vous transportent dans un autre temps. Tous sont accessibles
            facilement depuis La Villa Bouyssou.
          </motion.p>
        </div>
      </section>
