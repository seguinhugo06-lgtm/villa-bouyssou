...
export default function CastlesPage() {
  ...
  const sortedCastles = [...castles].sort((a, b) =>
    ...
    <main className="min-h-screen bg-cream">
      ...
      <section className="relative py-20 px-6 bg-navy">
        <div className="max-w-5xl mx-auto">
          ...
          >
            Voyagez au Coeur de l&apos;Histoire, decouvrez les Chateaux du Perigord Noir
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Le Perigord Noir est une terre de chateaux. Forteresses medievales, demeures
            Renaissance et chateaux de legende ponctuent les falaises et les vallees de la
            Dordogne. Chaque visite est un voyage dans le temps, a quelques minutes seulement
            de La Villa Bouyssou.
          </motion.p>
        </div>
      </section>
