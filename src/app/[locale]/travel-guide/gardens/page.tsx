    ...
    <main className="min-h-screen bg-cream">
      ...
      <section className="relative py-20 px-6 bg-navy">
        <div className="max-w-5xl mx-auto">
          ...
          >
            Tresors Vegetaux du Perigord : Decouverte des Jardins d&apos;Exception
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Le Perigord recele des jardins d&apos;une beaute exceptionnelle. Des buis sculptes de
            Marqueyssac aux topiaires d&apos;Eyrignac, en passant par les bambous exotiques de
            Planbuisson, ces jardins offrent des promenades enchantees a decouvrir au fil
            des saisons.
          </motion.p>
        </div>
      </section>
